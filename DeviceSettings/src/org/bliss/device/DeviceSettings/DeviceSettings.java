...
import org.bliss.device.DeviceSettings.Constants;
import org.bliss.device.DeviceSettings.R;
import org.bliss.device.DeviceSettings.SuShell;
import org.bliss.device.DeviceSettings.SuTask;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.bliss.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.bliss.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
